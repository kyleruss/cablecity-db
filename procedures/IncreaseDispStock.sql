...
-- Increases the stock of a dispatch desp_num by num_units
-- Checking for bad quantity is done in UpdateDispStock

CREATE OR REPLACE PROCEDURE increaseDispStock (desp_num NUMBER, num_units NUMBER)
IS
...
BEGIN
	...
	-- Update the dispatch quantity with the incremented quantity
